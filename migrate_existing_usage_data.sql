-- Migration script to populate new usage tracking tables with existing data
-- This will create realistic historical data based on your current usage

-- 1. First, let's create some sample file uploads based on your existing provider usage
-- This will generate realistic historical data for the past 12 months
...
-- 4. Update the existing api_keys table with more accurate totals
...
-- 5. Update provider_usage table with more accurate data
...
RAISE NOTICE 'You can now use calendar range and file type filtering with real data.';
