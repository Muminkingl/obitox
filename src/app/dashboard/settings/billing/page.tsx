                            ...
                            <div className="flex justify-between items-start">
                                <div className="space-y-2">
                                    ...
                                    <p className="text-sm text-muted-foreground max-w-[200px]">
                                        {loading ? '...' : (subscriptionData?.description || 'Our most popular plan for Hobby projects.')}
                                    </p>
                                </div>
                                <div className="text-right">
                                    <span className="text-4xl font-bold">
                                        ${subscriptionData?.monthly_price !== undefined ? subscriptionData.monthly_price : (subscriptionData?.plan_name === 'Enterprise' ? 299 : subscriptionData?.plan_name === 'Pro' ? 24 : 0)}
                                    </span>
