...
export async function GET(request: NextRequest) {
    ...
    try {
        ...
        const tierDetails = planFeatures || {
            free: { name: 'Free', price: 0, description: 'Perfect for testing and hobby projects', max_domains: 3, max_api_keys: 5, max_batch: 10 },
            pro: { name: 'Pro', price: 9, description: 'Best for startups and production apps', max_domains: 10, max_api_keys: 20, max_batch: 100 },
            enterprise: { name: 'Enterprise', price: 299, description: 'For high-volume applications', max_domains: 1000, max_api_keys: 999999, max_batch: 10000 }
        ...
        const responseData = {
            ...
            data: {
                ...
                description: planFeatures?.description || (tierDetails as any)?.description || 'Our most popular plan for Hobby projects.',
