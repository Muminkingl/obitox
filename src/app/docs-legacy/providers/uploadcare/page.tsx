...
import {
    ...
    FileText, Settings, Image as ImageIcon, Scan, Crop, Activity
} from "lucide-react";
...
export default function UploadcareProviderPage() {
    ...
    return (
        <article className="max-w-4xl space-y-12">
                ...
                <div className="relative">
                    ...
                    <div className="relative space-y-4">
                        ...
                        <p className="text-xl text-slate-300 leading-relaxed max-w-3xl">
                            Intelligent file CDN with <strong className="text-white">smart image optimization</strong> and
                            <strong className="text-white"> automatic virus scanning</strong>. Transform images on-the-fly without extra infrastructure.
                        </p>
                    </div>
                </div>
            </div>
            ...
            {/* Quick Start Wizard */}
            <div className="space-y-6 rounded-xl border border-pink-500/20 bg-gradient-to-br from-pink-500/5 to-transparent p-8">
                <div className="flex items-center gap-3">
                    <div className="flex items-center justify-center w-10 h-10 rounded-full bg-pink-500/10 border border-pink-500/20">
                ...
                <div className="space-y-3">
                    <div className="flex items-center gap-3">
                        ...
                        <h3 id="get-api-keys" className="text-lg font-semibold text-white">Get API Keys</h3>
                    </div>

                    <div className="ml-11 text-sm text-slate-400 space-y-2">
                        <p>Go to <a href="https://uploadcare.com/dashboard/" target="_blank" className="text-pink-400 hover:text-pink-300">Uploadcare Dashboard</a> → Settings → API Keys:</p>
                        <ul className="list-disc list-inside space-y-1 ml-4">
                            <li>Copy <strong className="text-white">Public Key</strong> (safe for client-side)</li>
                            <li>Copy <strong className="text-white">Secret Key</strong> (keep private, needed for virus scanning)</li>
                        </ul>
                    </div>
                </div>
...
UPLOADCARE_SECRET_KEY=xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx`}
                        />
                    </div>
                </div>
                ...
                <div className="space-y-3">
                    <div className="flex items-center gap-3">
                        ...
                        <h3 id="upload-with-optimization" className="text-lg font-semibold text-white">Upload with Optimization</h3>
                    </div>
            ...
            <div className="space-y-6">
                ...
                >
                    <CodeBlock
                        language={currentLang}
                        code={code.manualOptimization}
                    />
                    <div className="mt-4 rounded-lg border border-slate-800 overflow-hidden">
                        <table className="w-full text-sm">
                            <thead className="bg-slate-900 border-b border-slate-800">
                                <tr>
                                    <th className="text-left p-3 text-white font-semibold">Option</th>
                                    <th className="text-left p-3 text-white font-semibold">Values</th>
                            ...
                            <tbody className="divide-y divide-slate-800">
                                <tr className="hover:bg-slate-900/50">
                                    ...
                                    <td className="p-3 text-slate-400">auto, webp, jpeg, png</td>
                                    <td className="p-3 text-slate-400">Output image format</td>
                                </tr>
                                <tr className="hover:bg-slate-900/50">
                                    <td className="p-3"><code className="text-pink-400">quality</code></td>
                                    <td className="p-3 text-slate-400">lightest to best</td>
                                    <td className="p-3 text-slate-400">Compression level</td>
                                </tr>
                                <tr className="hover:bg-slate-900/50">
                                    <td className="p-3"><code className="text-pink-400">adaptiveQuality</code></td>
                                    <td className="p-3 text-slate-400">true/false</td>
                                    <td className="p-3 text-slate-400">AI quality optimization</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
            ...
            <div className="space-y-6">
                <div className="flex items-center gap-3">
                    ...
                    <h2 id="virus-scanning" className="text-2xl font-bold text-white">Virus Scanning</h2>
                </div>
                    ...
                    <div className="mt-4 rounded-lg border border-red-500/20 bg-red-500/5 p-4">
                        <div className="flex items-start gap-2">
                            ...
                            <div className="text-sm text-slate-300">
                                <strong className="text-red-400">Security:</strong> Infected files are automatically deleted from storage to protect your users.
                            </div>
                        </div>
                    </div>
                </OperationSection>
            ...
            <div className="space-y-6">
                <div className="flex items-center gap-3">
                    ...
                    <h2 id="transformations" className="text-2xl font-bold text-white">On-the-fly Transformations</h2>
                </div>
                ...
                >
                    <div className="space-y-4">
                        <div>
                            <h4 className="text-sm font-semibold text-white mb-2">Resize</h4>
                            <div className="p-3 rounded-lg bg-slate-950 font-mono text-sm text-slate-300 border border-slate-800 break-all">
                                https://ucarecdn.com/uuid/<span className="text-purple-400">-/resize/800x600/</span>photo.jpg
                            </div>
                        </div>
                        <div>
                            <h4 className="text-sm font-semibold text-white mb-2">Convert Format</h4>
                            <div className="p-3 rounded-lg bg-slate-950 font-mono text-sm text-slate-300 border border-slate-800 break-all">
                                https://ucarecdn.com/uuid/<span className="text-purple-400">-/format/webp/</span>photo.jpg
                            </div>
                        </div>
                        <div>
                            <h4 className="text-sm font-semibold text-white mb-2">Crop & Quality</h4>
                            <div className="p-3 rounded-lg bg-slate-950 font-mono text-sm text-slate-300 border border-slate-800 break-all">
                                https://ucarecdn.com/uuid/<span className="text-purple-400">-/crop/300x300/center/-/quality/best/</span>photo.jpg
                            </div>
                        </div>
                    </div>
                </OperationSection>
            ...
            <div className="space-y-6">
                <div className="flex items-center gap-3">
                    ...
                    <h2 id="download-urls" className="text-2xl font-bold text-white">Download & CDN</h2>
                </div>
            ...
            {/* Pro Tips */}
            <div className="rounded-xl border border-pink-500/20 bg-gradient-to-br from-pink-500/5 to-transparent p-8">
            ...
            <div className="pt-10">
                ...
                <div className="flex items-center justify-between pb-10">
                    <Link
                        ...
                        className="group flex items-center gap-2 text-white font-medium hover:text-pink-400 transition-colors"
                    >
...
function OperationCard({ icon, title, description, href }: {
    ...
    return (
        <a
            href={href}
            className="group p-4 rounded-lg border border-slate-800 bg-slate-900/30 hover:border-pink-500/30 hover:bg-pink-500/5 transition-colors"
        >
            <div className="flex items-start gap-3">
                <div className="text-slate-400 group-hover:text-pink-400 transition-colors [&>svg]:h-5 [&>svg]:w-5">
                    {icon}
                </div>
                <div>
...
function ProTip({ icon, title, description }: {
    ...
    return (
        <div className="flex items-start gap-3 p-4 rounded-lg bg-slate-950/50 border border-slate-800">
            <div className="text-pink-400 [&>svg]:h-5 [&>svg]:w-5">
                {icon}
            </div>
            <div>
