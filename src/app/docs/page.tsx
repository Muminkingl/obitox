            ...
            <DocsBody>
                ...
                <Cards>
                    <Card
                        ...
                        href="/docs/installation?lang=node"
                        title="Node.js"
                        description="JavaScript runtime built on Chrome's V8 engine"
                    />
                    <Card
                        icon={<span className="text-lg">⚡</span>}
                        href="/docs/installation?lang=next"
                        title="Next.js"
                        description="The React Framework for the Web"
                    />
                    <Card
                        icon={<span className="text-lg">🚂</span>}
                        href="/docs/installation?lang=express"
                        title="Express"
                        description="Fast, unopinionated web framework for Node.js"
                    />
                    <Card
                        icon={<span className="text-lg">🐍</span>}
                        href="/docs/installation?lang=python"
                        title="Python"
                        description="Programming language that lets you work quickly"
                    />
                    <Card
                        icon={<span className="text-lg">🐘</span>}
                        href="/docs/installation?lang=php"
                        title="PHP"
                        description="Popular general-purpose scripting language"
                    />
                    <Card
                        icon={<span className="text-lg">🎨</span>}
                        href="/docs/installation?lang=laravel"
                        title="Laravel"
                        description="PHP web application framework with expressive syntax"
                    />
                    <Card
                        icon={<span className="text-lg">🐹</span>}
                        href="/docs/installation?lang=go"
                        title="Go"
                        description="Build simple, secure, scalable systems"
                    />
                    <Card
                        icon={<span className="text-lg">💎</span>}
                        href="/docs/installation?lang=ruby"
                        title="Ruby"
