    ...
    <DocsPage toc={tocItems}>
      ...
      <DocsBody>
        ...
        <Callout type="info" title="Prerequisites">
          This guide assumes you've completed the <Link href="/docs/installation" className="text-fd-primary hover:underline">installation</Link> and have your API credentials ready.
        </Callout>
  ...
  if (error.code === 'QUOTA_EXCEEDED') {
    ...
    console.error('Upload failed:', error.message);
        ...
        <ul className="list-disc pl-6 space-y-2">
          <li><Link href="/docs/providers/s3" className="text-fd-primary hover:underline">S3 Provider Configuration</Link> - Advanced S3 settings and optimization</li>
          <li><Link href="/docs/transformations" className="text-fd-primary hover:underline">Image Transformations</Link> - Resize, crop, and optimize images</li>
          <li><Link href="/docs/cdn" className="text-fd-primary hover:underline">CDN Integration</Link> - Deliver files faster with CDN</li>
          <li><Link href="/docs/security" className="text-fd-primary hover:underline">Security Best Practices</Link> - Secure your API keys and uploads</li>
        </ul>
